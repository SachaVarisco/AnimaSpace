...
public class TornadoMovementNotifier : MonoBehaviour
{
    public event Action OnMovementComplete; // Evento que se activa cuando el tornado completa su movimiento
